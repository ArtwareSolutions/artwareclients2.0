...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { description: @artwork.description, dimensions: @artwork.dimensions, medium: @artwork.medium, title: @artwork.title, year: @artwork.year }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { description: @artwork.description, dimensions: @artwork.dimensions, medium: @artwork.medium, title: @artwork.title, year: @artwork.year }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
