...
class ExhibitionsControllerTest < ActionController::TestCase
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post :create, exhibition: { city: @exhibition.city, closing: @exhibition.closing, comment: @exhibition.comment, opening: @exhibition.opening, site: @exhibition.site, title: @exhibition.title }
    end
  ...
  test "should update exhibition" do
    patch :update, id: @exhibition, exhibition: { city: @exhibition.city, closing: @exhibition.closing, comment: @exhibition.comment, opening: @exhibition.opening, site: @exhibition.site, title: @exhibition.title }
    assert_redirected_to exhibition_path(assigns(:exhibition))
  end
